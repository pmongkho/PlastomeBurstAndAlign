...
#Compare the test with the correct dataset to ensure refactor did not mess up results.
correct_dir = script_dir + "/benchmarking1_correct"

dcmp = filecmp.dircmp(script_dir+"/benchmarking1", correct_dir)
